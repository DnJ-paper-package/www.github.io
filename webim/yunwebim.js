...
var  yunwebim = {
    ...
    createMessageHtml:function( type,msg )
    {
        ...
        switch (type) {
            case MsgType.MSG_TYPE_SINGLE_TEXT:
                ...
                html += str = '<img src="img/wap3_03.png" class="header_icon"><pre  class="youspeak">'+ msg +'</pre>';
                break;
        }
    ...
    /*
     ...
     4 文本图片数组 msg_data=[{subType:'text',value:'hello'},{subType:'img',value:'b.jpg'}];
...
(function()
{
    window.IM = window.IM ||
            {
                _appid : '', //应用ID
                _3rdServer : '/webim/3rd.php', //3rdServer，主要用来虚拟用户服务器获取SIG
                ...
                autoreply : function(){
                    if(IM._userdata.is_auto_reply == 0){
                        if(IM._userdata.auto_reply.status == 1){
                            ...
                            var str = '<div msg="msg" class="alert alert-left alert-info" style="block"><img src="img/wap3_03.png" class="header_icon"><pre  class="youspeak">'+newcontent+'</pre></div>';
                            $('#im_content_list').append(str);
...
//                    IM.EV_getGroupList();
                ...
                DO_push_createMsgDiv : function(obj){
                    ...
                    if(0 == obj.mcmEvent){//0普通im消息
                        ...
                        if(1 == msgType || 0 == msgType){
                            ...
                            str = '<img src="img/wap3_03.png" class="header_icon"><pre class="youspeak">'+ str +'</pre>';
                ...
                DO_sendMsg : function(){
                    ...
                    var str = '<img src="img/wap3_07.png"  class="header_icon"><pre msgtype="content" class="ownspeak">'+ im_send_content +'</pre>';
